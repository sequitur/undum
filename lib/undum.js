...
var isMobileDevice = function() {
    /*
    Scrolling will well and truly break on iOS devices, but we have no
    reliable way of checking for them beyond user agent strings.

    Hell is other people's devices.
    */
    return $("html").width() <= 700;
};

var disableScrolling = function() {
	return isMobileDevice() || navigator.userAgent.toLowerCase().search(/iphone|ipad|palm|blackberry|android/) >= 0;
};
